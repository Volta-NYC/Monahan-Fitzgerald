  ...
  return <>
    ...
    <section className="home-intro">
      <div className="shell home-intro__grid">
        ...
        <div className="home-intro__mosaic reveal reveal-mask" data-parallax="0.065">
    ...
    <section className="home-party">
      <div className="home-party__media reveal reveal-mask" data-parallax="0.055"><div className="home-party__image"><Image src="/images/gallery-social-1.jpeg" alt="Monahan and Fitzgerald’s upstairs event room set for dinner" fill sizes="(max-width: 760px) 100vw, 52vw" /></div><div className="home-party__detail"><Image src="/images/gallery-social-2.jpeg" alt="A private-event table set with navy linens and greenery" fill sizes="(max-width: 760px) 48vw, 22vw" /></div></div>
    ...
    <section className="social-gallery">
      <div className="social-gallery__image social-gallery__image--wide reveal reveal-mask" data-parallax="0.05"><Image src="/images/gallery-social-3.jpeg" alt="A birthday buffet in the upstairs event room" fill sizes="(max-width: 760px) 100vw, 66vw" /></div>
      <div className="social-gallery__image reveal reveal-mask" data-parallax="0.075"><Image src="/images/gallery-social-4.jpeg" alt="Guinness artwork and flowers in the upstairs room" fill sizes="(max-width: 760px) 100vw, 34vw" /></div>
