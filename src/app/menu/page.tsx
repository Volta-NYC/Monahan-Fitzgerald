...
export default function MenuPage() {
  return <>
    ...
    <section className="menu-intro">
      <div className="menu-intro__main reveal reveal-mask" data-parallax="0.065"><Image src="/images/fish-and-chips.png" alt="Fish and chips at Monahan and Fitzgerald" fill sizes="(max-width: 760px) 100vw, 64vw" /></div>
      <div className="menu-intro__side reveal reveal-mask" data-parallax="0.09"><Image src="/images/gallery-room-5.png" alt="Filet mignon sliders and fries" fill sizes="(max-width: 760px) 100vw, 36vw" /></div>
    ...
    <section className="menu-page shell">
      {menu.map((group, index) => <article id={slug(group.category)} key={group.category} className={`menu-group reveal ${index % 2 ? "menu-group--reverse" : ""}`}>
        <div className="menu-group__photo reveal-mask" data-parallax="0.045"><Image src={menuImages[group.category].src} alt={menuImages[group.category].alt} fill sizes="(max-width: 760px) 100vw, 42vw" /></div>
